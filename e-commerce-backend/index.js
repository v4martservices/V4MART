...
// mongoose.connect(
//   "mongodb+srv://vishal:Vishal%40123@cluster0.r5lucju.mongodb.net/e-commerce"
// );
...
cloudinary.config({ 
  cloud_name: 'dfyeocysu', 
  api_key: '257288994468845', 
  api_secret: 'LyrKwSaKt4gyMCO1djYCAPwLhwA' 
});
...
// Upload endpoint modified to use Cloudinary
app.post("/upload", upload.single("product"), uploadToCloudinary, (req, res) => {
  res.json({
    success: 1,
